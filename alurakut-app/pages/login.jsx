...
export default function LoginScreen() {
    const router = useRouter(); //solução de rotas do next
    const [githubUser, setGithubUser] = useState("bernardoblasquez");
   
    const handleSubmitLogin = (infosDoEvento) => {
    ...
    // to way binding
    const inputUsuarioHandle = (event) => {
